...
const showFiling = computed(() => showIcp.value || showPolice.value || !!appStore.customFilingHtml)
</script>
    ...
    >
      ...
      <div class="flex flex-col gap-2 sm:flex-row sm:gap-6">
        ...
        <div class="flex flex-wrap gap-1 items-center">
          ...
          <a
            href="https://github.com/hn1318/komari-theme-naive-modify"
            target="_blank"
            rel="noopener noreferrer"
            class="text-decoration-none transition-opacity hover:opacity-80"
          >
      ...
      <div v-if="showFiling" class="flex flex-wrap gap-2 items-center sm:flex-shrink-0">
        ...
        <!-- 自定义备案 HTML（仅管理员配置，内容受信任） -->
        <div
          v-if="appStore.customFilingHtml"
          class="filing-custom-html"
          v-html="appStore.customFilingHtml"
        />
      </div>
    </div>
  </NLayoutFooter>
